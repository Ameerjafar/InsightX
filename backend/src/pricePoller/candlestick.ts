...
//       let price: {} = {};
//       const prices = await fetch("wss://stream.binance.com:9443/ws/btcusdt@trade").then((response) => {
...
//         }
//       }
//       await redis.publish("klinesChannel", JSON.stringify({ type: "klines", data: allData, price}));
//     } catch (err) {
